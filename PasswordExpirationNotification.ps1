...
po połączeniu naciśnij <b>CTRL</b>+<b>ALT</b>+<b>Delete</b> i wybierz Zmień Hasło <br><br>
<p>Przypominam, że połączenie VPN jak i dostęp do zasobów (np. INFOMEX) czy dostęp do panelu Helpdesk jest skorelowane z Twoim kontem Windows. Oznacza to, że dane do autoryzacji w tych miejscach są pobierane z danych Twojego konta Windows.<br> 
